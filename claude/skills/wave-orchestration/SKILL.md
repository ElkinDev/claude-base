...
- A visual change is not ready to ask until its mockup exists in the owner-facing mockups folder, one file per change, the file path in the list item, so the owner can approve, reject or give feedback on the picture before any implementation starts.
