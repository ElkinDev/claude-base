...
3. Prove the build identity first: the install or update time of the package on the device and the build marker the brief names, before any cell runs. A wrong build ends the round with an identity FAIL and no cells.
