#!/usr/bin/env python3
"""Tests for compact-at-boundary.py (transcript tail, Herdr parsing, one pass end to end) and
...
fake subprocess result. Nothing runs a model, nothing submits a prompt anywhere. The decision
function has no fixtures of its own and is tested in test-compaction-decide.py beside this file.
