...
A session can be opened with a role, `cc work -o orchestrator`, `-o lane` (the default) or `-o research`. The role does four things and nothing else, and the fourth, the seat, is what turns a role into a chair.
